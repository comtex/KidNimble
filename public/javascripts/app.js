...
/*_______________________________*/
	...
	function getReviewData(camp_id){
        ...
        $.each(data, function(i,e) {
          	html += '<div class="twelve review">';
			html += '	<div class="one columns">';
			html += '	<img src="/assets/template/startCommets.png" alt="#" class="startCommets">';
			html += '	</div>';
			html += '	<div class="eleven columns">';
			html += '	    <div class="row comments reviews_comment">';
			html += '			<p>'+e['note']+'</p>';
			html += '			<h4>'+e['first_name'] + ' ' + e['last_name'].charAt(0);
								if(e['source_url'] != null && e['source_url'] != '' && e['source_url'] != 'null'){ 
			html += '				<a style="float:right;" href="'+e['source_url']+'" alt="'+e['source_url']+'"><img src="/assets/ratingz.net_logo.jpg" alt="'+e['source_url']+'" width="100" /></a>';
								}
			html += ' 			<h4>';
			html += '			<ul id="rater">';
        ...
        if (data.length == 0) {
          html += '<div class="twelve review"><div class="one columns"></div><div class="eleven columns"><h5>No reviews.</h5></div></div>';
        }
        $('#reviews').html(html);
      });
	}
